...
#define __PYX_HAVE__c104f__config
#define __PYX_HAVE_API__c104f__config
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "c104f.config" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "c104f.config"
extern int __pyx_module_is_main_c104f__config;
int __pyx_module_is_main_c104f__config = 0;

/* Implementation of "c104f.config" */
...
#define __pyx_kp_u_10_10_17_105 __pyx_string_tab[1]
#define __pyx_kp_u__2 __pyx_string_tab[2]
#define __pyx_n_u_BASE_DIR __pyx_string_tab[3]
#define __pyx_n_u_CLIENT_DIR __pyx_string_tab[4]
...
__Pyx_RefNannySetupContext("PyInit_config", 0);
  ...
  if (__pyx_module_is_main_c104f__config) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "c104f.config")) {
      if (unlikely((PyDict_SetItemString(modules, "c104f.config", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init c104f.config", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init c104f.config");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
 ...
 *     "confirm_interval",
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(4, __pyx_mstate_global->__pyx_n_u_connection_timeout, __pyx_mstate_global->__pyx_n_u_message_timeout, __pyx_mstate_global->__pyx_n_u_confirm_interval, __pyx_mstate_global->__pyx_n_u_keep_alive_interval); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 5, __pyx_L1_error)
...
const char* const bytes = ".10.10.17.105?BASE_DIRCLIENT_DIRCLIENT_FOLDERFILES_DIRFILES_FOLDERPROTOCOL_CONFIGSECTION_SIZESEGMENT_SIZESERVERSSERVER_DIRSERVER_FOLDERabspathclient_sidecline_in_tracebackcollectionsconfirm_intervalconnection_timeoutdirnamefield_names__file__filesjoinkeep_alive_interval__main__message_timeout__module____name__namedtupleospathprotocol_configprotocol_fieldnames__qualname__server_sidesetdefault__test__typename";
  ...
  }
  {
    ...
    int16_t const cint_constants_2[] = {230,2404,10000};
    for (int i = 0; i < 5; i++) {
